...
double RealisticEngineModel::getRealAcceleration(double speed_mps, double accel_mps2, double reqAccel_mps2, double timeStep) {
    ...
    if (reqAccel_mps2 >= 0) {
        ...
        //has been requested
        double engineAccel = std::min(maxEngineAcceleration_mps2(correctedSpeed)- thrust_NToAcceleration_mps2(opposingForce_N(speed_mps)), reqAccel_mps2);
        ...
        realAccel_mps2 = alpha * engineAccel + (1 - alpha) * accel_mps2 ;
//        std::cout << "###########################" << std::endl;
//        std::cout << "acc des: "<< reqAccel_mps2 << std::endl;
//        std::cout << "engine acc: "<< engineAccel << std::endl;
//        std::cout << "accel_mps2: "<< accel_mps2 << std::endl;
//        //std::cout << "currentAccel_mps2: "<< currentAccel_mps2 << std::endl;
//        std::cout << "opposing acceleration: "<< thrust_NToAcceleration_mps2(opposingForce_N(speed_mps)) << std::endl;
//        std::cout << "realAccel_mps2: "<< realAccel_mps2 << std::endl;
//        std::cout << "###########################" << std::endl;
...
double RealisticEngineModel::getRealBrakingAcceleration(double speed_mps, double accel_mps2, double reqAccel_mps2, double t) {
