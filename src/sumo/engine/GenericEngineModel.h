...
#include "sumo/utils/common/Parameterised.h"
...
public:
     ...
     * squared second
     */
    virtual double getRealAcceleration(double speed_mps, double accel_mps2, double reqAccel_mps2, double timeStep = 0) = 0;
